...
著作权信息
----
本项目本身基于Python独立进行开发，遵循 [cc by nc sa](http://creativecommons.org/licenses/by-nc-sa/2.0/) 协议 \
本项目的早期代码有部分来自于 [dieloli](https://github.com/pokemonchw/dieloli) \

...
5. 在描写{TargetName}的脸部时，将形容词和名词一起使用{face}来替代。如'柔软的脸颊'改为'{face}'。
## 描述文本的要求

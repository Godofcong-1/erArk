...
def build_character_happy():
    with open(data_path,encoding="utf-8") as now_file:
        ...
        for row in now_read:
            ...
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{add_small_str})'
            ...
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{add_medium_str})'
            ...
            out_str += f'\n    change_data.status.setdefault({cid},0)'
            out_str += f'\n    change_data.status[{cid}] += character_happy\n\n'
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{add_large_str})'
            ...
            out_str += f'\n    change_data.status.setdefault({cid},0)'
            out_str += f'\n    change_data.status[{cid}] += character_happy\n\n'
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{sub_small_str})'
            ...
            out_str += f'\n    change_data.status.setdefault({cid},0)'
            out_str += f'\n    change_data.status[{cid}] -= character_happy\n\n'
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{sub_medium_str})'
            ...
            out_str += f'\n    change_data.status.setdefault({cid},0)'
            out_str += f'\n    change_data.status[{cid}] -= character_happy\n\n'
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{sub_large_str})'

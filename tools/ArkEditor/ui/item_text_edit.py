...
class ItemTextEdit(QWidget):
    ...
    def create_right_click_menu(self):
        ...
        clothing_items = [
            ...
            {"text": "交互对象的胸衣名字", "slot": lambda: self.insert_text('{TagetBraName}')},
            {"text": "交互对象的裙子名字", "slot": lambda: self.insert_text('{TagetSkiName}')},
            {"text": "交互对象的内裤名字", "slot": lambda: self.insert_text('{TagetPanName}')},
            {"text": "交互对象的袜子名字", "slot": lambda: self.insert_text('{TagetSocName}')},

...
def build_character_skills():
    with open(data_path,encoding="utf-8") as now_file:
        ...
        for row in now_read:
            ...
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{small_str})'
            ...
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{medium_str})'
            ...
            out_str += f'\n    change_data.knowledge.setdefault({cid},0)'
            out_str += f'\n    change_data.knowledge[{cid}] += experience\n\n'
            out_str += f'\n@settle_behavior.add_settle_behavior_effect(constant_effect.BehaviorEffect.{large_str})'

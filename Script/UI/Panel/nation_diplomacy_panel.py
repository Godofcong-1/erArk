...
class Nation_Diplomacy_Panel:
    ...
    def draw(self):
        ...
        while 1:
            ...
            info_text_list = [_("势力名称"), _("势力声望"), _("源石病治愈率(未实装)")]
            ...
            for nation_id in all_nation_list:
                ...
                nation_text = f"{nation_name.center(str_text_width,'　')}{now_nation_reputation_str.center(text_width,' ')}{now_country_treatment_progress.center(text_width,' ')}"

    ...
    def __init__(self, character_id: int, width: int, column: int, center_status: bool = True):
        ...
        if character_id != 0:
            ...
            if character_data.ability[31] == 0:
                now_text += "  普普通通的舌头\n"
            if character_data.dirty.mouse_semen_all == 0:
                now_text += "  未品尝过精液\n"
            body_text_list.append(now_text)
            #胸部信息#
            now_text = f"\n 【胸】\n"
            if character_data.dirty.breast_semen_all == 0:
                now_text += "  未淋上过精液\n"
            body_text_list.append(now_text)
            #指部信息#
            now_text = f"\n 【指】\n"
            if character_data.dirty.hand_semen_all == 0:
                now_text += "  未淋上过精液\n"
            body_text_list.append(now_text)
            #足部信息#
            now_text = f"\n 【足】\n"
            if character_data.dirty.foot_semen_all == 0:
                now_text += "  未淋上过精液\n"
            body_text_list.append(now_text)
            #膣部信息#
            now_text = f"\n 【膣】\n"
            ...
            if character_data.dirty.sex_semen_all == 0:
                now_text += "  未射入过精液\n"
            body_text_list.append(now_text)
            #肛部信息#
            now_text = f"\n 【肛】\n"
            ...
            if character_data.dirty.a_sex_semen_all == 0:
                now_text += "  未射入过精液\n"
            body_text_list.append(now_text)
            #子宫信息#
            now_text = f"\n 【宫】\n"
            ...
            #尿道信息#
            now_text = f"\n 【尿】\n"
            if character_data.dirty.urethral_semen_all == 0:
                now_text += "  未射入过精液\n"
            body_text_list.append(now_text)
        if self.center_status:
            now_draw = panel.CenterDrawTextListPanel()

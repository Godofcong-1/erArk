...
from Script.UI.Panel import game_info_panel, see_character_info_panel, dirty_panel, cloth_panel, group_sex_panel, see_instruct_panel, chara_image_list_panel
...
from Script.Design import attr_text, map_handle, handle_premise_place

...
instruct_en2cn = {"VIBRATOR_INSERTION" : "震动棒","VIBRATOR_INSERTION_ANAL" : "肛门震动棒","NORMAL_SEX" : "正常位","BACK_SEX" : "背后位","RIDING_SEX" : "骑乘位","FACE_SEAT_SEX" : "对面座位","BACK_SEAT_SEX" : "背面座位","FACE_STAND_SEX" : "对面立位","BACK_STAND_SEX" : "背面立位","STIMULATE_G_POINT" : "刺激G点", "WOMB_OS_CARESS": "玩弄子宫口", "WOMB_INSERTION":"插入子宫口", "WOMB_SEX" : "子宫姦","NORMAL_ANAL_SEX" : "正常位肛交","BACK_ANAL_SEX" : "后背位肛交","RIDING_ANAL_SEX" : "骑乘位肛交","FACE_SEAT_ANAL_SEX" : "对面座位肛交","BACK_SEAT_ANAL_SEX" : "背面座位肛交","FACE_STAND_ANAL_SEX" : "对面立位肛交","BACK_STAND_ANAL_SEX" : "背面立位肛交", "STIMULATE_SIGMOID_COLON": "玩弄s状结肠", "STIMULATE_VAGINA" : "隔着刺激阴道", "DOUBLE_PENETRATION" : "二穴插入", "KEEP_ENJOY" : "继续享受"}
""" H指令的中英文对照 """

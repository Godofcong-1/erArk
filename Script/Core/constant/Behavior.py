class Behavior:
    ...
    """ 对目标香薰疗愈_催眠 """
    AROMATHERAPY_7 = "aromatherapy_7"
    """ 对目标香薰疗愈_射精 """
    AROMATHERAPY_8 = "aromatherapy_8"
    """ 对目标香薰疗愈_疲劳 """
    ...
    """ 翘课（心情因素主动不上课，非体力不足） """
    CHECK_REPORT_CARD = "check_report_card"
    """ 检查成绩单 """
    INTERN_CLASS = "intern_class"
    """ 实习（实习课：跟着在岗干员学该岗位的手艺） """
    FOLLOW_MOTHER = "follow_mother"
    """ 跟随母亲见学 """
    FREE_PLAY = "free_play"
    ...
    """ 病房查房 """
    ORGANIZE_DORMITORY_OPINION = "organize_dormitory_opinion"
    """ 整理宿舍意见 """
    HANDLE_DORMITORY_PROBLEM = "handle_dormitory_problem"
    """ 处理宿舍问题 """
    ...
    """ 结束群交 """
    START_SEX_CLASS = "start_sex_class"
    """ 开始性技实操课（Plan 22 四期） """
    END_SEX_CLASS = "end_sex_class"
    """ 结束性技实操课（Plan 22 四期） """
    PRENATAL_TALK = "prenatal_talk"
    """ 对孕肚说话（Plan 22 四期） """
    PRENATAL_MUSIC = "prenatal_music"
    """ 给孕肚放音乐（Plan 22 四期） """
    PRENATAL_TOUCH = "prenatal_touch"
    """ 抚摸孕肚（Plan 22 四期） """
    JOIN_SEX_CLASS = "join_sex_class"
    """ 到场参加性技实操课（二段，Plan 22 四期） """
    WATCH_SEX_CLASS = "watch_sex_class"
    """ 旁观性技实操课（二段，Plan 22 四期） """
    ...
    """ 自己加入群交 """
    REFUSE_JOIN_GROUP_SEX = "refuse_join_group_sex"
    """ 拒绝加入群交 """
    OTHER_SEX_BE_FOUND_TO_GROUP_SEX = "other_sex_be_found_to_group_sex"
    """ 其他H中被发现转群交 """
    DISCOVER_OTHER_SEX_AND_JOIN = "discover_other_sex_and_join"
    """ 发现其他H并加入转群交 """
    ASK_HIDDEN_SEX = "ask_hidden_sex"
    """ 邀请隐奸 """
    ASK_HIDDEN_SEX_FAIL = "ask_hidden_sex_fail"
    """ 邀请隐奸失败 """
    OTHER_SEX_BE_FOUND_TO_HIDDEN_SEX = "other_sex_be_found_to_hidden_sex"
    """ 其他H中被发现转隐奸 """
    ASK_EXHIBITIONISM_SEX = "ask_exhibitionism_sex"
    """ 邀请露出性爱 """
    ASK_EXHIBITIONISM_SEX_FAIL = "ask_exhibitionism_sex_fail"
    """ 邀请露出性爱失败 """
    OTHER_SEX_BE_FOUND_TO_EXHIBITIONISM_SEX = "other_sex_be_found_to_exhibitionism_sex"
    """ 其他H中被发现转露出 """
    H_INTERRUPT = "h_interrupt"
    """ H时被人目击闯入中断 """
    SEE_H_AND_INTERRUPT = "see_h_and_interrupt"
    """ 目击H并打断 """
    SEE_H_BUT_DECEIVED = "see_h_but_deceived"
    """ 目击H但被骗走 """
    SEE_H_AND_LEAVE = "see_h_and_leave"
    """ 目击H并离开 """
    SEE_H_BUT_IGNORE = "see_h_but_ignore"
    """ 目击H并无视 """
    ...
    """ 摘掉避孕套 """
    HANG_CONDOM_DECORATION = "hang_condom_decoration"
    """ 挂上避孕套装饰 """
    TAKE_BACK_CONDOM_DECORATION = "take_back_condom_decoration"
    """ 取回避孕套装饰 """
    DRINK_CONDOM_SEMEN = "drink_condom_semen"
    """ 饮用避孕套精液 """
    SQUEEZE_CONDOM_SEMEN = "squeeze_condom_semen"
    """ 挤出避孕套精液 """
    ...
    """ 脱衣并穿回衣柜衣服 """
    REMOTE_TURN_OFF_SEX_TOY = "remote_turn_off_sex_toy"
    """ 遥控关闭情趣道具 """
    REMOTE_TURN_ON_SEX_TOY = "remote_turn_on_sex_toy"
    """ 遥控开启情趣玩具 """
    REMOTE_SET_SEX_TOY_WEAK = "remote_set_sex_toy_weak"
    """ 将情趣玩具调到弱档 """
    REMOTE_SET_SEX_TOY_WEAK_TO_MEDIUM = "remote_set_sex_toy_weak_to_medium"
    """ 将情趣玩具从弱档调到中档 """
    REMOTE_SET_SEX_TOY_STRONG_TO_MEDIUM = "remote_set_sex_toy_strong_to_medium"
    """ 将情趣玩具从强档调到中档 """
    REMOTE_SET_SEX_TOY_STRONG = "remote_set_sex_toy_strong"
    """ 将情趣玩具调到强档 """
    REMOTE_ALL_TURN_OFF_SEX_TOY = "remote_all_turn_off_sex_toy"
    """ 遥控关闭全员情趣道具 """
    ...
    """ 检查翅膀 """
    EXAMINE_WING_FLEXIBILITY = "examine_wing_flexibility"
    """ 测试翅膀灵活度 """
    ...
    """ 在时停中再次停止 """
    S_ORGASM_SMALL = "s_orgasm_small"
    """ 结算S小绝顶 """
    S_ORGASM_NORMAL = "s_orgasm_normal"
    """ 结算S普绝顶 """
    S_ORGASM_STRONG = "s_orgasm_strong"
    """ 结算S强绝顶 """
    S_ORGASM_SUPER = "s_orgasm_super"
    """ 结算S超强绝顶 """
    ...
    """ 结算超大量射精 """
    P_NO_SEMEN_CLIMAX = "p_no_semen_climax"
    """ 结算无精液高潮 """
    ...
    """ 结算W超强绝顶 """
    M_ORGASM_SMALL = "m_orgasm_small"
    """ 结算M小绝顶 """
    M_ORGASM_NORMAL = "m_orgasm_normal"
    """ 结算M普绝顶 """
    M_ORGASM_STRONG = "m_orgasm_strong"
    """ 结算M强绝顶 """
    M_ORGASM_SUPER = "m_orgasm_super"
    """ 结算M超强绝顶 """
    F_ORGASM_SMALL = "f_orgasm_small"
    """ 结算F小绝顶 """
    F_ORGASM_NORMAL = "f_orgasm_normal"
    """ 结算F普绝顶 """
    F_ORGASM_STRONG = "f_orgasm_strong"
    """ 结算F强绝顶 """
    F_ORGASM_SUPER = "f_orgasm_super"
    """ 结算F超强绝顶 """
    H_ORGASM_SMALL = "h_orgasm_small"
    """ 结算H小绝顶 """
    H_ORGASM_NORMAL = "h_orgasm_normal"
    """ 结算H普绝顶 """
    H_ORGASM_STRONG = "h_orgasm_strong"
    """ 结算H强绝顶 """
    H_ORGASM_SUPER = "h_orgasm_super"
    """ 结算H超强绝顶 """
    ...
    """ 结算八重绝顶 """
    PLURAL_ORGASM_9 = "plural_orgasm_9"
    """ 结算九重绝顶 """
    PLURAL_ORGASM_10 = "plural_orgasm_10"
    """ 结算十重绝顶 """
    PLURAL_ORGASM_11 = "plural_orgasm_11"
    """ 结算十一重绝顶 """
    S_ORGASM_EDGE = "s_orgasm_edge"
    """ 结算S绝顶被寸止 """
    ...
    """ 结算W绝顶被寸止 """
    M_ORGASM_EDGE = "m_orgasm_edge"
    """ 结算M绝顶被寸止 """
    F_ORGASM_EDGE = "f_orgasm_edge"
    """ 结算F绝顶被寸止 """
    H_ORGASM_EDGE = "h_orgasm_edge"
    """ 结算H绝顶被寸止 """
    ...
    """ 结算A处女 """
    FIRST_U_SEX = "first_u_sex"
    """ 结算U处女 """
    FIRST_W_SEX = "first_w_sex"
    """ 结算W处女 """
    FIRST_KISS_BUT_PENIS = "first_kiss_but_penis"
    """ 结算阴茎初吻 """
    ...
    """ 结算阴茎蹭耳朵中 """
    PENIS_IN_BODY_15 = "penis_in_body_15"
    """ 结算深喉口交中 """

...
@add_instruct(
    ...
    {constant.Premise.HAVE_TARGET,
    constant.Premise.NOT_H,
    constant.Premise.PLACE_HAVE_FURNITURE,
    constant.Premise.SLEEP_LE_89}
)
...
@add_instruct(
    ...
    {constant.Premise.HAVE_TARGET,
    constant.Premise.IS_H,
    constant.Premise.HAVE_SAFE_CANDLES},
)

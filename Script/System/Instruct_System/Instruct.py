class Instruct:
    ...
    """ 挤出避孕套精液 """
    HANG_CONDOM_DECORATION_DAILY = "hang_condom_decoration_daily"
    """ 挂上避孕套装饰（非H） """
    TAKE_BACK_CONDOM_DECORATION_DAILY = "take_back_condom_decoration_daily"
    """ 取回避孕套装饰（非H） """
    DRINK_CONDOM_SEMEN_DAILY = "drink_condom_semen_daily"
    """ 饮用避孕套精液（非H） """
    SQUEEZE_CONDOM_SEMEN_DAILY = "squeeze_condom_semen_daily"
    """ 挤出避孕套精液（非H） """

...
## 6. 日常结算与日志
- [x] **6.1 settle_medical_department()**：在 `Script/System/medical/medical_service.py` 中新增入口函数，内部按需调用 `patient_management.py` / `hospital_flow.py` 的工具方法，`update_base_resouce_newday()` 调用，负责：
